...
{
    public class CreateAccountHandler : IRequestHandler<CreateCustomerCommand, CustomerResponse>
    {
        private readonly IRepository<Customer> _customerRepo;
        public CreateAccountHandler(IRepository<Customer> customerRepository)
        {
